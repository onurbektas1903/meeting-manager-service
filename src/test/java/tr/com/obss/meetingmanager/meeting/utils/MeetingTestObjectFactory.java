...
public class MeetingTestObjectFactory {
  ...
  public static MeetingDTO createMeetingDTO() {
    return MeetingDTO.builder()
            ...
            .meetingProvider(createMeetingProviderDTO(GOOGLE))
            .start(START_DATE)
            .end(END_DATE)
  ...
  public static List<RecipientDTO> createRecipientsDTOList() {
   return Arrays.asList(new RecipientDTO(RECIPIENT1_ID,RECIPIENT1_NAME),new RecipientDTO(RECIPIENT2_ID,RECIPIENT2_NAME));
  }
